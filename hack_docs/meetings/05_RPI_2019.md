...
## Accessibility
**Campus:** Due to the nature of Rensselaer's private campus, gates that require special access are needed for those who require the ability to park at Folsom Library. Jen can make special arrangements to accommodate easier access to Folsom Library. Please email Jen privately (kubaj@rpi.edu). 
